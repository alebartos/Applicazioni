...
import { Users, MessageCircle, Table, Trash2, UserPlus, RefreshCw, Play, Pause, Square, RotateCcw, Radio, Clock, Trophy, Send } from 'lucide-react';
...
export function AdminPanel({ adminName, onLogout }: AdminPanelProps) {
          ...
          <CardContent className="px-4 sm:px-6">
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:flex lg:flex-wrap gap-2 sm:gap-3">
              {gameStatus.status === 'not_started' && (
                <Button onClick={handleStartGame} disabled={isLoading} className="bg-green-600 hover:bg-green-700 min-h-[44px]" size="sm">
              ...
              {gameStatus.status === 'active' && (
                <Button onClick={handlePauseGame} disabled={isLoading} variant="outline" className="min-h-[44px]" size="sm">
              ...
              {gameStatus.status === 'paused' && (
                <>
                  <Button onClick={handleResumeGame} disabled={isLoading} className="bg-green-600 hover:bg-green-700 min-h-[44px]" size="sm">
                    <Play className="w-4 h-4 mr-2" />
                    Riprendi Gioco
                  </Button>
                  <Button onClick={handleEndGame} disabled={isLoading} variant="destructive" className="min-h-[44px]" size="sm">
              ...
              <Button onClick={handleResetGame} disabled={isLoading} variant="outline" className="border-destructive text-destructive hover:bg-destructive hover:text-destructive-foreground min-h-[44px] sm:col-span-2 lg:col-span-1" size="sm">
